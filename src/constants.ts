...
export const CHAT_MESSAGE_HISTORY_STORAGE = 'open-pencil:chat-history'
export const CHAT_CLI_SESSION_STORAGE = 'open-pencil:chat-cli-session'
export const CHAT_SUBAGENT_COUNT_STORAGE = 'open-pencil:chat-subagent-count'
export const CHAT_PROMPT_HISTORY_STORAGE = 'open-pencil:chat-prompt-history'
export const CHAT_PROMPT_HISTORY_LIMIT = 50
export const CHAT_SUBAGENT_COUNT_MIN = 1
export const CHAT_SUBAGENT_COUNT_MAX = 5
export const CHAT_ATTACHMENT_PLACEHOLDER_URL_PREFIX = 'openpencil://attachment/'
export const CHAT_ATTACHMENT_DB_NAME = 'open-pencil-chat'
export const CHAT_ATTACHMENT_DB_VERSION = 1
export const CHAT_ATTACHMENT_STORE_NAME = 'attachments'
export const CHAT_IMAGE_UPLOAD_MAX_EDGE = 1536
export const CHAT_IMAGE_UPLOAD_MAX_BYTES = 450_000
